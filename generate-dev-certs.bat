@echo off
REM Script para generar certificados SSL auto-firmados para desarrollo local en Windows
REM Basado en la guía de implementación HTTPS para Adomi Backend
...
openssl req -x509 -newkey rsa:4096 -keyout ssl\key.pem -out ssl\cert.pem -days 365 -nodes -subj "/C=CL/ST=Region/L=Ciudad/O=Adomi/OU=Development/CN=localhost"
